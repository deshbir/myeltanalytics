...
// define Leaflet as an AMD module
	...
	define('panels/bettermap/leaflet/leaflet-src',L);
}
...
define('css!panels/bettermap/module.css', ['css-embed'], 
function(embed)
{
	embed(
	'/** custom additions **/ .leaflet-marker-icon {   color: #333; }'
	);
	return true;
});


define('css!panels/bettermap/leaflet/leaflet.css', ['css-embed'], 
function(embed)
{
	embed(
 ...
 */
define('panels/bettermap/module',[
  'angular',
  'app',
  'lodash',
  './leaflet/leaflet-src',
